...
- Language breakdown: 0 Korean, 22 English, 0 Chinese, 0 Japanese, 0 German, 0 French, 0 Russian, 0 Other
...
|-----------|---------|----------|
| GREEN | 22 | Israel Eliminates Iran Security Chief Ali Larijani in Tehran Strike; Basij Commander Also Killed, Iran War Creates Biggest Oil Supply Disruption in History — Strait of Hormuz Effectively Closed, Iran War Pushes South and Southeast Asia into Energy Triage — India, Bangladesh, Nepal Impose Emergency Rationing and 19 |
...
> Active tracking threads: 57 | Strengthening: 0 | Weakening: 0 | Faded: 0
...
| Trend | 7 | {{FSSF_DIST_TR_REPR}} | {{FSSF_DIST_TR_NOTE}} |
| Megatrend | 0 | {{FSSF_DIST_MT_REPR}} | {{FSSF_DIST_MT_NOTE}} |
| Driver | 2 | {{FSSF_DIST_DR_REPR}} | {{FSSF_DIST_DR_NOTE}} |
| Wild Card | 2 | {{FSSF_DIST_WC_REPR}} | {{FSSF_DIST_WC_NOTE}} |
| Discontinuity | 2 | {{FSSF_DIST_DC_REPR}} | {{FSSF_DIST_DC_NOTE}} |
