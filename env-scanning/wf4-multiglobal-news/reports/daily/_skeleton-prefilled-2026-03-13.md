...
> **Scan Window**: March 11, 2026 22:13 UTC ~ March 12, 2026 22:13 UTC (24 hours)
...
### Key Changes Summary
- New signals detected: 1149
- Top priority signals: 1149
- Major impact domains: {{DOMAIN_DISTRIBUTION}}

### Crawling Statistics Summary
- Sites crawled: 36 sites, 36 succeeded, 0 failed
- Language breakdown: 863 Korean, 602 English, 3 Chinese, 29 Japanese, 3 German, 17 French, 100 Russian, 100 Other
- Translation: 1115 translated, 0 failed
...
|-----------|---------|----------|
| GREEN | 1149 | 국악 소녀서 ‘트로트 스타’로… “하루아침에 인생이 활짝 폈어요”, 58개 장면이 쇼츠처럼 ‘휙휙’ 무대 위로 옮긴 알고리즘 감옥, 北, 日 장거리 미사일 실전 배치 비난… “열도 침몰 자초” and 1146 |
...
|-----------|---------|-----------|-----------|
| Weak Signal | 36 | {{FSSF_DIST_WS_REPR}} | {{FSSF_DIST_WS_NOTE}} |
| Emerging Issue | 25 | {{FSSF_DIST_EI_REPR}} | {{FSSF_DIST_EI_NOTE}} |
| Trend | 948 | {{FSSF_DIST_TR_REPR}} | {{FSSF_DIST_TR_NOTE}} |
| Megatrend | 6 | {{FSSF_DIST_MT_REPR}} | {{FSSF_DIST_MT_NOTE}} |
| Driver | 49 | {{FSSF_DIST_DR_REPR}} | {{FSSF_DIST_DR_NOTE}} |
| Wild Card | 36 | {{FSSF_DIST_WC_REPR}} | {{FSSF_DIST_WC_NOTE}} |
| Discontinuity | 4 | {{FSSF_DIST_DC_REPR}} | {{FSSF_DIST_DC_NOTE}} |
| Precursor Event | 45 | {{FSSF_DIST_PE_REPR}} | {{FSSF_DIST_PE_NOTE}} |
...
| Site | Language | Articles | Strategy | Success Rate |
|------|----------|----------|----------|--------------|
| joongang | ko | 248 | web_crawl | 100% |
| sedaily | ko | 118 | web_crawl | 100% |
| apnews | en | 113 | web_crawl | 100% |
...
| scmp | en | 50 | rss | 100% |
| mk | ko | 49 | rss | 100% |
| techcrunch | en | 44 | web_crawl | 100% |
| nytimes | en | 38 | rss | 100% |
| bbc | en | 37 | rss | 100% |
| arabnews | en | 32 | web_crawl | 100% |
| khan | ko | 31 | rss | 100% |
| reuters | en | 31 | web_crawl | 100% |
| etnews | ko | 30 | rss | 100% |
| politico | en | 30 | rss | 100% |
| hani | ko | 29 | rss | 100% |
| nikkei | ja | 29 | web_crawl | 100% |
| aljazeera | en | 25 | rss | 100% |
| nknews | en | 25 | web_crawl | 100% |
| aitimes | ko | 24 | rss | 100% |
| wsj | en | 20 | rss | 100% |
...
| handelsblatt | de | 3 | web_crawl | 100% |
| sciencetimes | ko | 2 | web_crawl | 100% |

| Item | Value |
|------|-------|
| Crawling Datetime | 2026-03-13T00:31:42.263561+00:00 |
| Total Sites Crawled | 36 |
| Sites Succeeded | 36 |
| Sites Failed | 0 |
| Total Articles Collected | 1717 |
| S/N Ratio | 1717:1717 |
...
| Item | Value |
|------|-------|
| Total Translated | 1115 |
| Translation Failed | 0 |
| By Language — Korean | 863 |
| By Language — English | 602 |
| By Language — Chinese | 3 |
| By Language — Japanese | 29 |
