...
> **Scan Window**: March 10, 2026 22:24 UTC ~ March 11, 2026 22:24 UTC (24 hours)
> **Anchor Time (T₀)**: March 11, 2026 22:24:37 UTC
...
|-----------|---------|----------|
| GREEN | 1074 | 美, 301조 조사 나서며 한국의 문제로 거론한 것은? “자동차·기계·철강·선박 등 제조업 과잉생산”, 美 기대 인플레이션 1년만 최고치...심화하는 ‘S의 공포’, ‘일본의 임윤찬’ 마사야 카메이 공연...조선멤버십 초대권 이벤트 [조멤 컬처 시리즈] and 1071 |
...
|-----------|---------|-----------|-----------|
| Weak Signal | 22 | {{FSSF_DIST_WS_REPR}} | {{FSSF_DIST_WS_NOTE}} |
| Emerging Issue | 899 | {{FSSF_DIST_EI_REPR}} | {{FSSF_DIST_EI_NOTE}} |
| Trend | 1 | {{FSSF_DIST_TR_REPR}} | {{FSSF_DIST_TR_NOTE}} |
| Megatrend | 0 | {{FSSF_DIST_MT_REPR}} | {{FSSF_DIST_MT_NOTE}} |
| Driver | 27 | {{FSSF_DIST_DR_REPR}} | {{FSSF_DIST_DR_NOTE}} |
| Wild Card | 122 | {{FSSF_DIST_WC_REPR}} | {{FSSF_DIST_WC_NOTE}} |
